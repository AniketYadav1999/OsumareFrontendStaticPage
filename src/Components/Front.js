...
const Front=()=> {
  ...
  <div class="container-fluid">
    <img className="logo" src="./image/logo.png" alt="logo"></img>
      ...
      <form class="d-flex" role="search">
        <button class="Contact" type="contact">Contact us</button>
      </form>
    </div>
</nav>
    <div className="text text-center">
         ...
         <button className="getstart bg-primary">Get started</button>
    </div>
    <div>
        <img className="mx-auto d-block my-5" src="./image/Header image.png"></img>
        <h3 className="imagedata"><b>Real Estate-Focused Digital Mastery</b></h3>
    </div>
    <div className="container1 row-cols-my-2 m-5">
        <div className="cuate">
            <img src="./image/cuate.png"></img>
        </div>
        <div className="subcontainer1">
        <h3 className="imagedata mt-1"><b>Unlock the Potential of Digital Real Estate Excellence</b></h3>
        <p className="para2 ms-5">At Osumare, we understand that the real estate landscape demands a digital presence that aligns with the intricacies of property marketing. Our range of specialized services is meticulously designed to catapult your brand's success in the ever-evolving digital property market.</p>
    ...
    <div className="serviceoffer">
        ...
        <h4 className="imagedata mt-5"><b>Your Peace of Mind</b></h4>
        <p className="justify">Through our conversion-focused strategies, we ensure that property<br/> seekers are not just visitors, but engaged prospects ready to make<br/> their next move in the real estate market</p>
        <button  class="Contact text-light bg-primary fs-5 btn-center ms-5 my-5" >Get started</button>
    </div>
    <div className="serviceoffer">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./image/Testimonial card.png" class="d-block w-100" alt="..."/>
    </div>
...
<div className="serviceoffer">
        <h3 className="imagedata mt-1"><b>Frequently Asked Questions</b></h3>
        <p className="para1 text-center">Pinpoint your audience with precision, ensuring your marketing efforts reach those most likely to engage with your brand.</p>
    ...
    <div className="serviceoffer">
        <h3 className="imagedata mt-1"><b>Connect with Our Digital Marketing Experts</b></h3>
        <p className="para1 text-center">Reach Out for Tailored Strategies and Results-Driven Solutions. Let's Elevate Your Online Presence Together</p>
    </div>
